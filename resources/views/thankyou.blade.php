...
<div class="vh-100 d-flex justify-content-center align-items-center">
    <div>
        ...
        <div class="text-center">
            ...
            <button class="btn btn-primary" id="fillAgainBtn">Fill Again</button>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
          ...
          // Get the previous URL from the query parameter
          const previousUrl = new URLSearchParams(window.location.search).get('previous');
        
          // Add an event listener to the "Fill Again" button
          fillAgainBtn.addEventListener('click', function () {
            if (previousUrl) {
              window.location.href = previousUrl;
            } else {
              // Default redirection if previous URL is not available
